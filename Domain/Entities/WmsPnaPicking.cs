...
public partial class WmsPnaPicking
{
    [Key]
    ...
    [Column("BINPRIORITY_1")]
    public int? Binpriority1 { get; set; }
    ...
    [Column("BINPRIORITY_2")]
    public int? Binpriority2 { get; set; }
    ...
    [Column("BINPRIORITY_3")]
    public int? Binpriority3 { get; set; }
    ...
    [Column("BINPRIORITY_4")]
    public int? Binpriority4 { get; set; }
    ...
    [Column("BINPRIORITY_5")]
    public int? Binpriority5 { get; set; }
